...
<marquee behaviour="scroll" direction="left" scrollamount="4" style="font-size: 16px;padding-top: 0px;font-weight:550; margin:auto auto; color:blue">
    ...
    <?php
    $query = "SELECT faculty.id as id, faculty.name, department.dept_name, department.designation 
    FROM department,faculty WHERE department.id=faculty.id AND dept_type='nonteaching' Order by faculty.id+0; ";
    $list = mysqli_query($connection, $query); ?>
